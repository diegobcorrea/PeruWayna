<?php
/**
 * Template Name: Admin - Profesor Horarios
 */
...
get_header(); ?>
	...
	<?php if ( is_user_logged_in() ) : ?>
		...
		<form id="HourTeacherForm" class="form-horizontal" role="form">
			<div class="h4 add-bottom"><strong>Consultar Horas de Profesor</strong></div>
			<div class="col-md-12">
				<div class="col-lg-5">
					<div class="form-group">
						<label for="inputName" class="col-sm-4 control-label text-right">Nombre</label>
						<div class="col-sm-8">
							<?php $getTeachers = $wpdb->get_results( "SELECT * FROM wp_bs_teacher", OBJECT ); ?>
							<select name="id_teacher" id="inputIDteacher">
							<?php foreach ($getTeachers as $teacher) : ?>
								<option value="<?php echo $teacher->id_teacher; ?>"><?php echo $teacher->name_teacher ?> <?php echo $teacher->lastname_teacher ?></option>
							<?php endforeach; ?>
							</select>
						</div>
					</div>
				...
				<div class="col-lg-2">
					<a class="form-control btn btn-secundary" id="teacher-exportExcel">Exportar Excel</a>
				</div>
			</div>
			<div class="col-md-12 add-bottom">
				...
				<div class="col-lg-2">
					<input type="submit" class="form-control btn btn-secundary" id="teacher-seeHours" value="Consultar">
				</div>
			</div>
		</form>
		...
		<div id="table-hours" class="row add-top" style="display: none;">
			...
			<div class="form-group col-md-6">
				<label for="suspend" class="col-sm-8 control-label text-right">Total de horas suspendidas que<br/> tenían un alumno</label>
				<div class="col-sm-4">
			...
			<div class="form-group col-md-6">
				<label for="suspendwos" class="col-sm-8 control-label text-right">Total de horas suspendidas<br/> que NO tenían un alumno</label>
				<div class="col-sm-4">
